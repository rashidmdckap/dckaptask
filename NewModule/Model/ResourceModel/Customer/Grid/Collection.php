...
namespace DCKAP\NewModule\Model\ResourceModel\Customer\Grid;
...
use DCKAP\NewModule\Model\ResourceModel\Post\Collection as PostCollection;
...
class Collection extends PostCollection implements SearchResultInterface
{
    ...
    protected function _getAllIdsSelect($limit = null, $offset = null)
    {
        ...
        $idsSelect->columns($this->getResource()->getentity_idFieldName(), 'main_table');
